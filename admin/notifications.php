...
// Mark all as read now that the user is viewing this page.
// Done AFTER fetching (so we can still show which ones were unread on this load)
// but BEFORE the navbar renders below, so the bell badge clears immediately.
